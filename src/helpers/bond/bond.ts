...
export abstract class Bond {
    ...
    public readonly bondPriceDecimals?: number;
    ...
    public abstract getAPEAmount(networkID: Networks, provider: StaticJsonRpcProvider): Promise<number>;
    ...
    constructor(type: BondType, bondOpts: BondOpts) {
        ...
        this.bondPriceDecimals = bondOpts.bondPriceDecimals || this.decimals;
    }
