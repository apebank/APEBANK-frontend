export const messages = {
    please_connect: "Please connect your wallet to the Boba network to use APEBANK.",
    please_connect_wallet: "Please connect your wallet.",
    try_bond_more: (value: string) => `You're trying to bond more than the maximum payout available! The maximum bond payout is ${value} APE.`,
    ...
    switch_to_right_network: "Switch to the Boba network?",
