...
export { abi as BondDepositoryContract } from "./bonds/BondDepositoryContract.json";
...
export { abi as sAPETokenContract } from "./tokens/sAPEContract.json";
export { abi as APETokenContract } from "./tokens/APEContract.json";
export { abi as USDTTokenContract } from "./tokens/USDTContract.json";
export { abi as wsAPETokenContract } from "./tokens/wsAPEContract.json";
